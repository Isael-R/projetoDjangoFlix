...
from .views import Homepage, Homefilmes, Detalhefilme, Pesquisafilme,EditarPerfil, Criarconta
...
urlpatterns = [
    ...
    path('editarpertil/<int:pk>', EditarPerfil.as_view(), name='editarperfil'),
